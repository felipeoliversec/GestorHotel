                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-user-plus"></i> Cadastro de Hóspedes - <small>Inclusão</small>
                        </button>
                    </div>
                    <div class="ibox-content">
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="meusdadosg.php"-->
                            ...
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="hospedesg.php">
                                ...
                                <div class="tab-content">
                                    ...
                                    <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="meusdadosg.php"-->
                                        <div class="row">
                                            <div class="col-lg-4 text-center">
                                                <h2>Novo Hóspede</h2>
                                                <div class="m-b-sm">
                                                    <img alt="image" class="img-circle" src="<?php echo 'img/semfoto.jpg'; ?>"
                                                         style="width: 82px">
                                                </div>

                                                <div class="m-b-sm">
                                                    <input type=hidden name="defoto" value="<?php echo 'img/semfoto.jpg'; ?>">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <input id="cdhosp" name="cdhosp" type="text" value="" placeholder="somente números" class="form-control" maxlength = "14" autofocus required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="textinput">Nome</label>
                                                    <div class="col-md-10">
                                                        <input id="dehosp" name="dehosp" value="" type="text" placeholder="" class="form-control" maxlength = "100" required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="textinput">E-Mail</label>
                                                    <div class="col-md-10">
                                                        <input id="demail" name="demail" value="" type="e-mail" placeholder="seuemail@provedor.com" class="form-control" maxlength = "255">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="textinput">Última Estadia</label>
                                                    <div class="col-md-5">
                                                        <input id="dtulti" name="dtulti" value="" type="date" placeholder="" class="form-control" maxlength = "10">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="textinput">Último Pagamento</label>
                                                    <div class="col-md-4">
                                                        <input id="vlulti" name="vlulti" value="" type="text" placeholder="999,99" class="form-control" maxlength = "10">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                    ...
                                    <div id="tab-2" class="tab-pane">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-1">
                                                <input id="nrende" name="nrende" value="" type="text" placeholder="Ex: 187" class="form-control" maxlength = "6">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input id="decida" name="decida" value="" type="text" placeholder="São Paulo" class="form-control" maxlength = "50">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Estado</label>
                                            <div class="col-md-1">
                                                <input id="cdesta" name="cdesta" value="" type="text" placeholder="SP" class="form-control" maxlength = "02">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Cep</label>
                                            <div class="col-md-2">
                                                <input id="nrcep" name="nrcep" value="" type="text" placeholder="67876020" class="form-control" maxlength = "08">
                                            </div>
                                        </div>
                                    ...
                                    <div id="tab-3" class="tab-pane">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-1">
                                                <input id="nrdddf" name="nrdddf" value="" type="text" placeholder="12" class="form-control" maxlength = "04">
                                            </div>
                                            <div class="col-md-4">
                                                <input id="nrfixo" name="nrfixo" value="" type="text" placeholder="12345678" class="form-control" maxlength = "08">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Celular</label>
                                            <div class="col-md-1">
                                                <input id="nrdddc" name="nrdddc" value="" type="text" placeholder="12" class="form-control" maxlength = "04">
                                            </div>
                                            <div class="col-md-4">
                                                <input id="nrcelu" name="nrcelu" value="" type="text" placeholder="123456789" class="form-control" maxlength = "09">
                                            </div>
                                        </div>
                                    </div>
                                </div>
