<?php
    ...
    $aReservas= ConsultarDados("reservas", "cdclie", $cdclie, false, false);
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-hotel"></i> Reservas / Hospedagens
                        </button>
                    </div>
                    <div class="ibox-content">
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="usuariosa.php"-->
                            <div class="pull-left">
                                <a onclick="#" href="reservasi.php" class="btn btn-primary ">Incluir</a>
                            </div>
                                    ...
                                    <tbody>
                                        <?php for ($f =0; $f <= (count($aReservas)-1); $f++) { ?>
                                            <tr class="gradeX">
                                                ...
                                                <?php $edita = "reservasa.php?acao=edita&chave=".$coluna1; ?>
