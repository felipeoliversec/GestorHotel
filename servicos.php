                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-shopping-cart"></i> Cadastro de Serviços
                        </button>
                    </div>
                    <div class="ibox-content">
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="usuariosa.php"-->
                            <div class="pull-left">
                                <a onclick="#" href="servicosi.php" class="btn btn-primary ">Incluir</a>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        <?php for ($f =0; $f <= (count($aservicos)-1); $f++) { ?>
                                            <tr class="gradeX">

                                                <?php $data = strtotime($aservicos[$f]["dtcada"]) ;?>
                                                <?php $preco = number_format($aservicos[$f]["vlserv"],2,',','.') ;?>

                                                <?php $coluna1 = $aservicos[$f]["cdserv"]; ?>
                                                <?php $coluna2 = $aservicos[$f]["deserv"]; ?>
                                                <?php $coluna3 = $preco; ?>
                                                <?php $coluna4 = $aservicos[$f]["qtserv"]; ?>
