                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-shopping-cart"></i> Cadastro de Acomodações - <small>Inclusão Automática</small>
                        </button>
                    </div>
                    <div class="ibox-content">
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="meusdadosg.php"-->

                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="locaisgerarg.php">
                                ...
                                <div class="row">
                                    <!--div class="col-lg-6"-->
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Informe o número inicial da acomodação</label>
                                            <div class="col-md-2 ">
                                                <input id="deini" name="deini" type="number" value="" placeholder="Ex: 1" class="form-control" maxlength = "3" autofocus required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Informe o número final da acomodação</label>
                                            <div class="col-md-2 ">
                                                <input id="defim" name="defim" type="number" value="" placeholder="Ex: 999" class="form-control" maxlength = "3" autofocus required="">
                                            </div>
                                        </div>
                                    <!--/div-->
                                </div>
                                ...
                                <div>
                                    <center>
                                        ...
                                        <button class="btn btn-sm btn-primary " type="submit"><strong>Gerar</strong></button>
                                    </center>
                                </div>
