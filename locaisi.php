                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-hotel"></i> Cadastro de Acomodações - <small>Inclusão</small>
                        </button>
                    </div>
                    <div class="ibox-content">
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="meusdadosg.php"-->

                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="locaisg.php">
                                ...
                                <div class="row">
                                    <!--div class="col-lg-6"-->
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-1">
                                                <input id="cdloca" name="cdloca" type="text" value="" placeholder="001" class="form-control" maxlength = "03" autofocus required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Descrição</label>
                                            <div class="col-md-8">
                                                <input id="deloca" name="deloca" value="" type="text" placeholder="Ex: Suíte / Quarto / Chalé" class="form-control" maxlength = "50" required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Andar</label>
                                            <div class="col-md-1">
                                                <input id="nranda" name="nranda" value="01" type="text" placeholder="01" class="form-control" maxlength = "02">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Ramal</label>
                                            <div class="col-md-2">
                                                <input id="nrrama" name="nrrama" value="32456" type="text" placeholder="32456" class="form-control" maxlength = "20">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Capacidade</label>
                                            <div class="col-md-1">
                                                <input id="qthosp" name="qthosp" value="02" type="text" placeholder="02" class="form-control" maxlength = "02">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <textarea class="form-control" id="deobse" wrap="physical" cols=50 rows=3 name="deobse" placeholder="Ex: Quarto novo com tv+ar+cama extra"></textarea>
                                            </div>
                                        </div>
