<?php
    ...
    $aFuncionarios= ConsultarDados("funcionarios", "cdclie", $cdclie, false, false);
            ...
            <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-user"></i> Cadastro de Funcionários
                        </button>
                    </div>
                        ...
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="usuariosa.php"-->
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        <?php for ($f =0; $f <= (count($aFuncionarios)-1); $f++) { ?>
                                            <tr class="gradeX">

                                                <?php $data = strtotime($aFuncionarios[$f]["dtadmi"]);?>

                                                <?php $coluna1 = $aFuncionarios[$f]["cdfunc"]; ?>
                                                <?php $coluna2 = $aFuncionarios[$f]["defunc"]; ?>
                                                <?php $coluna3 = $aFuncionarios[$f]["nrtele"]; ?>
                                                <?php $coluna4 = $aFuncionarios[$f]["nrregi"]; ?>
                                                <?php $coluna5 = date("d/m/Y",$data); ?>

                                                <?php $ver = "funcionariosa.php?acao=ver&chave=".$coluna1; ?>
                                                <?php $edita = "funcionariosa.php?acao=edita&chave=".$coluna1; ?>
                                                <?php $apaga = "funcionariosa.php?acao=apaga&chave=".$coluna1; ?>
