                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-list-alt"></i> Estoques 
                        </button>
                    </div>
                    <div class="ibox-content">
                           <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="estoquesg.php">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            <input id="qtprod" name="qtprod" value="0" type="number" placeholder="" class="form-control" maxlength = "5">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="textinput">Entrada</label>
                                        <div class="col-md-1">
                                            <input id="cdtipo" name="cdtipo" value="E" type="text" placeholder="E" class="form-control" maxlength = "1">
                                            <span><small><strong>E</strong> - Entrada</small></span>
                                            <span><small><strong>S</strong> - Saída</small></span>
                                        </div>
                                    </div>
                                </div>
