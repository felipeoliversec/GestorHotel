<?php
    ...
    $alocais= ConsultarDados("locais", "cdclie", $cdclie, false, false);
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-hotel"></i> Cadastro de Acomodações
                        </button>
                    </div>
                    <div class="ibox-content">
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="usuariosa.php"-->
                            <div class="pull-left">
                                <a onclick="#" href="locaisi.php" class="btn btn-primary">Incluir</a>
                                <a onclick="#" href="locaisgerar.php" class="btn btn-success">Gerar Automático</a>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        <?php for ($f =0; $f <= (count($alocais)-1); $f++) { ?>
                                            <tr class="gradeX">

                                                <?php if ($alocais[$f]["cdtipo"] == "C") {?>
                                                    <?php  $cdtipo = "Casal" ;?>
                                                <?php } Else {?>
                                                    <?php  $cdtipo = "Solteiro" ;?>
                                                <?php }?>

                                                <?php $coluna1 = $alocais[$f]["cdloca"]; ?>
                                                <?php $coluna2 = $alocais[$f]["deloca"]; ?>
                                                <?php $coluna3 = $alocais[$f]["nranda"]; ?>
                                                <?php $coluna4 = $alocais[$f]["nrrama"]; ?>
                                                <?php $coluna5 = $alocais[$f]["qthosp"]; ?>
                                                <?php $coluna6 = $cdtipo; ?>

                                                <?php $ver = "locaisa.php?acao=ver&chave=".$coluna1; ?>
                                                <?php $edita = "locaisa.php?acao=edita&chave=".$coluna1; ?>
                                                <?php $apaga = "locaisa.php?acao=apaga&chave=".$coluna1; ?>
