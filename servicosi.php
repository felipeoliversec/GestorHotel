                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-shopping-cart"></i> Cadastro de Serviços - <small>Inclusão</small>
                        </button>
                    </div>
                                ...
                                <div class="row">
                                    <!--div class="col-lg-6"-->
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2 ">
                                                <input id="cdserv" name="cdserv" type="text" value="" placeholder="Diaria" class="form-control" maxlength = "15" autofocus required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Descrição</label>
                                            <div class="col-md-8">
                                                <input id="deserv" name="deserv" value="" type="text" placeholder="Diaria Normal" class="form-control" maxlength = "50" required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Preço</label>
                                            <div class="col-md-2">
                                                <input id="vlserv" name="vlserv" value="1,00" type="text" placeholder="" class="form-control" maxlength = "10">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Quantidade</label>
                                            <div class="col-md-2">
                                                <input id="qtserv" name="qtserv" value="1" type="text" placeholder="" class="form-control" maxlength = "5">
                                            </div>
                                        </div>
                                        <div class="form-group">
