<?php
    ...
    $aFuncionarios= ConsultarDados("funcionarios", "cdfunc", $chave, false, false,$cdclie);
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-user"></i> Cadastro de Funcionários - <small><?php echo $titulo; ?></small>
                        </button>
                    </div>
                    <div class="ibox-content">
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="meusdadosg.php"-->
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="funcionariosaa.php">
                                    ...
                                    <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="meusdadosg.php"-->
                                        ...
                                        <!--div class="col-lg-6"-->
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2 ">
                                                    <input id="cdfunc" name="cdfunc" type="text" value="<?php echo $aFuncionarios[0]["cdfunc"]; ?>" placeholder="021" class="form-control" maxlength = "03" autofocus readonly="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="textinput">Nome</label>
                                                <div class="col-md-8">
                                                    <input id="defunc" name="defunc" value="<?php echo $aFuncionarios[0]["defunc"]; ?>" type="text" placeholder="" class="form-control" maxlength = "100" required="">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="textinput">Telefone</label>
                                                <div class="col-md-2">
                                                    <input id="nrtele" name="nrtele" value="<?php echo $aFuncionarios[0]["nrtele"]; ?>" type="text" placeholder="11 9-2134-9876" class="form-control" maxlength = "20">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="textinput">Registro</label>
                                                <div class="col-md-2">
                                                    <input id="nrregi" name="nrregi" value="<?php echo $aFuncionarios[0]["nrregi"]; ?>" type="text" placeholder="" class="form-control" maxlength = "10">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="textinput">Nascimento</label>
                                                <div class="col-md-3">
                                                    <input id="dtnasc" name="dtnasc" value="<?php echo $aFuncionarios[0]["dtnasc"]; ?>" type="date" placeholder="" class="form-control" maxlength = "10">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="textinput">Admissão</label>
                                                <div class="col-md-3">
                                                    <input id="dtadmi" name="dtadmi" value="<?php echo $aFuncionarios[0]["dtadmi"]; ?>" type="date" placeholder="" class="form-control" maxlength = "10">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="textinput">Demissão</label>
                                                <div class="col-md-3">
                                                    <input id="dtdemi" name="dtdemi" value="<?php echo $aFuncionarios[0]["dtdemi"]; ?>" type="date" placeholder="" class="form-control" maxlength = "10">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="textarea">Observações</label>
                                                <div class="col-md-8">
                                                    <textarea class="form-control" id="deobse" wrap="physical" cols=50 rows=3 name="deobse" placeholder="Ex: Funcionário em regime de turno 1 x 24"><?php echo $aFuncionarios[0]["deobse"]; ?></textarea>
                                                </div>
                                            </div>
                                        <!--/div-->
                                        </div>
