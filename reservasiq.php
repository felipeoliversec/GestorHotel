            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                            ...
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="reservasgq.php">
                                    ...
                                    <div id="tab-1" class="tab-pane active">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <input id="cdloca" name="cdloca" value="<?php echo $chave;?>" type="text" placeholder="001" class="form-control" maxlength = "03" readonly="">
                                                </div>
                                            </div>
