<?php
    ...
    $aReservas= ConsultarDadosQ("reservas", "cdloca", $chave, false, false, $cdclie);
            ...
            <!--div class="col-lg-12"-->
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <?php $titu = "Reservas / Hospedagens - ".$chave ;?>
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-hotel"></i> <?php echo $titu;?>
                        </button>
                    </div>
                    <div class="ibox-content">
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="usuariosa.php"-->
                            <div class="pull-left">
                                <?php $reservasiq = "reservasiq.php?chave=".$chave;?>
                                <a onclick="#" href="<?php echo $reservasiq;?>" class="btn btn-primary">Incluir</a>
                            </div>
                                    ...
                                    <tbody>
                                        <?php for ($f =0; $f <= (count($aReservas)-1); $f++) { ?>
                                            <tr class="gradeX">
                                                ...
                                                <?php $dataR = ""?>
                                                <?php $coluna4 = $dataR; ?>
                                                <?php If (empty($aReservas[$f]["dtentr"]) == false) {?>
                                                    <?php if ($aReservas[$f]["dtentr"] !== "0000-00-00") {?>
                                                        <?php $dataR = strtotime($aReservas[$f]["dtentr"]) ;?>
                                                        <?php $coluna4 = date("d/m/Y",$dataR); ?>
                                                    <?php }?>
                                                <?php } ?>
                                                ...
                                                <?php $coluna3 = date("d/m/Y",$dataP); ?>

                                                <?php $coluna5 = "Não"; ?>
                                                <?php If (empty($aReservas[$f]["dtconf"]) == false) {?>
                                                    <?php if ($aReservas[$f]["dtconf"] !== "0000-00-00") {?>
                                                        <?php $dataC = strtotime($aReservas[$f]["dtconf"]); ?>
                                                        <?php $coluna5 = date("d/m/Y",$dataC); ?>
                                                    <?php } ?>
                                                <?php } ?>

                                                <?php $ver = "reservasaq.php?acao=ver&chave=".$coluna1; ?>
                                                <?php $pagar = "reservasaq.php?acao=pagar&chave=".$coluna1; ?>
                                                ...
                                                <td class="text-right">
                                                    <div class="btn-group">
                                                        <button class="fa fa-eye btn-white btn btn-xs" name="ver" type="button" onclick="window.open('<?php echo $ver;?>','_parent')"> Ver</button>
                                                        <?php if ($aReservas[$f]["dtentr"] !== "0000-00-00" and $aReservas[$f]["vlpago"] < 1.00) {?>
                                                            <button class="fa fa-money btn-white btn btn-xs" name="pagar" type="button" onclick="window.open('<?php echo $pagar;?>','_parent')"> Fechar</button>
                                                        <?php }?>
