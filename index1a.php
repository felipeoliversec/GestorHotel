...
<head>
    ...
    <title>Weber Hotel | Principal </title>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="agenda.php"><i class="fa fa-calendar"></i> <span class="nav-label">Calendário de Reservas</span></a>
                </li>
                <?php if ($fladmi == "A") {?>
                    <li>
        ...
        <?php
            ...
            $alocal=ConsultarDados("locais", "cdloca", null, false, false, $cdclie);
            $qtlinha=1; 
        ...
        <?php if (count($alocal) < 1) {?>
            <div class="ibox float-e-margins">
                ...
                <center><label>suporte@provedordemaildoseuhotel.com.br</label></center>
        </div>
        <?php }?>
