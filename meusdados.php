<?php
    ...
    // endereços
    $aEnde= ConsultarDados("enderecos", "cdende", $cdusua, false);
    if (count($aEnde) == 0) {
        $aNomes=array();
        $aNomes[]="cdende";
        $aNomes[]="deende";
    ...
    // telefones
    $aTele= ConsultarDados("telefones", "cdtele", $cdusua, false);
    if (count($aTele) == 0) {
        $aNomes=array();
        $aNomes[]="cdtele";
        $aNomes[]="nrdddf";
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input id="demail" name="demail" value="<?php echo $aUsua[0]["demail"]; ?>" type="e-mail" value="<?php echo $demail; ?>" placeholder="" class="form-control" maxlength = "255">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
