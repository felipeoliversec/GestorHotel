                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-user"></i> Cadastro de Funcionários - <small>Inclusão</small>
                        </button>
                    </div>
                    <div class="ibox-content">
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="meusdadosg.php"-->

                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="funcionariosg.php">
                                ...
                                <div class="row">
                                    <!--div class="col-lg-6"-->
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2 ">
                                                <input id="cdfunc" name="cdfunc" type="text" value="" placeholder="021" class="form-control" maxlength = "03" autofocus required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Nome</label>
                                            <div class="col-md-8">
                                                <input id="defunc" name="defunc" value="" type="text" placeholder="" class="form-control" maxlength = "100" required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Telefone</label>
                                            <div class="col-md-2">
                                                <input id="nrtele" name="nrtele" value="" type="text" placeholder="11 9-2134-9876" class="form-control" maxlength = "20">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Registro</label>
                                            <div class="col-md-2">
                                                <input id="nrregi" name="nrregi" value="" type="text" placeholder="" class="form-control" maxlength = "10">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Nascimento</label>
                                            <div class="col-md-3">
                                                <input id="dtnasc" name="dtnasc" value="" type="date" placeholder="" class="form-control" maxlength = "10">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Admissão</label>
                                            <div class="col-md-3">
                                                <input id="dtadmi" name="dtadmi" value="" type="date" placeholder="" class="form-control" maxlength = "10">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Demissão</label>
                                            <div class="col-md-3">
                                                <input id="dtdemi" name="dtdemi" value="" type="date" placeholder="" class="form-control" maxlength = "10">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textarea">Observações</label>
                                            <div class="col-md-8">
                                                <textarea class="form-control" id="deobse" wrap="physical" cols=50 rows=3 name="deobse" placeholder="Ex: Funcionário em regime de turno 1 x 24"></textarea>
                                            </div>
                                        </div>
                                    <!--/div-->
                                </div>
