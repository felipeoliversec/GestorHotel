<?php
    ...
    $aUsuarios= ConsultarDados("usuarios", "cdusua", $chave, false);
                                    ...
                                    <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="meusdadosg.php"-->
                                        <div class="row">
                                            <div class="col-lg-4 text-center">
                                                <h2><?php echo $aUsuarios[0]["deusua"]; ?></h2>
                                                <input type="hidden" name="defoto1" value = "<?php echo $aUsuarios[0]["defoto"]; ?>">
                                                <div class="m-b-sm">
                                                    <img alt="image" class="img-circle" src="<?php echo $aUsuarios[0]["defoto"]; ?>"
                                                         style="width: 82px">
                                                </div>
                                                <div class="m-b-sm">
                                                ...
                                                <div class="m-b-sm">
                                                    <input type=hidden name="defoto" value="<?php echo $aUsuarios[0]["defoto"]; ?>">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <input id="cdusua" name="cdusua" type="text" value="<?php echo formatar($aUsuarios[0]["cdusua"],"cpf"); ?>" placeholder="" class="form-control" maxlength = "20" autofocus readonly="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input id="deusua" name="deusua" value="<?php echo $aUsuarios[0]["deusua"]; ?>" type="text" placeholder="" class="form-control" maxlength = "100" required="">
                                                    </div>
                                                </div>
                                                <input type="hidden" name="demail1" value="<?php echo $aUsuarios[0]["demail"]; ?>">
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="textinput">E-Mail</label>
                                                    <div class="col-md-10">
                                                        <input id="demail" name="demail" value="<?php echo $aUsuarios[0]["demail"]; ?>" type="e-mail" placeholder="seuemail@provedor.com" class="form-control" maxlength = "255">
                                                    </div>
                                                </div>
                                                <input type="hidden" name="desenh1" value = "<?php echo $aUsuarios[0]["desenh"]; ?>">                                                
                                                <input type="hidden" name="cdclie" value = "<?php echo $cdclie; ?>">

                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="textinput">Senha</label>
                                                    <div class="col-md-10">
                                                        <input id="desenh" name="desenh" value="<?php echo $aUsuarios[0]["desenh"]; ?>" type="desenh" placeholder="" class="form-control" maxlength = "255">
                                                    <?php if (trim($acao) == "edita") {?>
                                                        <span><small><strong>Atenção:</strong><strong>a)</strong> A senha está criptografada. <strong>b)</strong> Altere se desejar!</small></span>
                                                    <?php }?>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <?php if ($aUsuarios[0]["fladmi"] == "A") {?>
                                                            <select name="fladmi" id="fladmi">
                                                                <option value='A' selected= "selected">Sim</option>
