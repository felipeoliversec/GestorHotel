<?php
    ...
    //$aCale= ConsultarDados("", "", $cdclie, false, false);

    $aCale = ConsultarReservasAgenda();
            ...
            <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-calendar"></i> Calendário de Reservas
                        </button>
                    </div>
                    <div class="ibox-content">
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="usuariosa.php"-->
                            <!--div class="pull-left"-->
                                <!--a onclick="#" href="funcionariosi.php" class="btn btn-primary ">Incluir</a-->
                            <!--/div-->
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    <thead>
                                        <tr>
                                            <th>Data Prevista Entrada</th>
                                            <th>Data Prevista Saída</th>
                                            <th>Acomodação</th>
                                            <th>Hóspede</th>
                                    ...
                                    <tbody>
                                        <?php for ($f =0; $f <= (count($aCale)-1); $f++) { ?>
                                            <tr class="gradeX">

                                                <?php $coluna1 = date("d-m-Y", strtotime($aCale[$f]["dtentp"])); ?>
                                                <?php $coluna2 = date("d-m-Y", strtotime($aCale[$f]["dtsaip"])); ?>
                                                <?php $coluna3 = $aCale[$f]["cdloca"].' - '.$aCale[$f]["deloca"]; ?>
                                                <?php $coluna4 = $aCale[$f]["cdhosp"].' - '.$aCale[$f]["deusua"]; ?>

                                                <?php $ver = "agendaa.php?acao=ver&chave=".$coluna1; ?>
                                                <?php $edita = "agendaa.php?acao=edita&chave=".$coluna1; ?>
                                                <?php $apaga = "agendaa.php?acao=apaga&chave=".$coluna1; ?>
                                                <td class="center"><?php print $coluna1; ?></td>
                                                <td class="center"><?php print $coluna2; ?></td>
                                                <td class="center"><?php print $coluna3; ?></td>
