            ...
            <!--div class="col-lg-12"-->
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <?php $titu = "Registrar Consumo - Reserva No.: ".$chave;?>
                    ...
                    <div class="ibox-content">
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="usuariosa.php"-->
                            <div class="pull-left">
                                <?php $incluir = "consumoii.php?chave=".$chave;?>
                                <a onclick="#" href="<?php echo $incluir;?>" class="btn btn-primary">Incluir</a>
                                    ...
                                    <tbody>
                                        <?php for ($f =0; $f <= (count($aConsumo)-1); $f++) { ?>
                                            <tr class="gradeX">
                                                ...
                                                <?php $ver = "consumoa.php?acao=ver&chave=".$coluna1; ?>
                                                <?php $edita = "consumoa.php?acao=edita&chave=".$coluna1; ?>
                                                <?php $apaga = "consumoa.php?acao=apaga&chave=".$coluna1; ?>
