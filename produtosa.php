<?php
    ...
    $aprodutos= ConsultarDados("produtos", "cdprod", $chave, false, false,$cdclie);
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-shopping-cart"></i> Cadastro de Produtos - <small><?php echo $titulo; ?></small>
                        </button>
                    </div>
                    <div class="ibox-content">
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="meusdadosg.php"-->
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="produtosaa.php">
                                <div class="row">
                                    <!--div class="col-lg-6"-->
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Código</label>
                                            <div class="col-md-2 ">
                                                <input id="cdprod" name="cdprod" type="text" value="<?php echo $aprodutos[0]["cdprod"]; ?>" placeholder="" class="form-control" maxlength = "15" readonly="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Descrição</label>
                                            <div class="col-md-8">
                                                <input id="deprod" name="deprod" value="<?php echo $aprodutos[0]["deprod"]; ?>" type="text" placeholder="Balas de Goma" class="form-control" maxlength = "50" required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Preço</label>
                                            <div class="col-md-2">
                                                <input id="vlprod" name="vlprod" value="<?php echo number_format($aprodutos[0]["vlprod"],2,',','.'); ?>" type="text" placeholder="" class="form-control" maxlength = "10">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Quantidade</label>
                                            <div class="col-md-2">
                                                <input id="qtprod" name="qtprod" value="<?php echo $aprodutos[0]["qtprod"]; ?>" type="text" placeholder="" class="form-control" maxlength = "5">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Ativo?</label>
                                            <div class="col-md-6">
                                                <?php if ($aprodutos[0]["flativ"] == "S") {?>
