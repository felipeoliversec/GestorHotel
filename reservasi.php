<?php
    ...
    $aHospedes= ConsultarDados("hospedes", "cdclie", $cdclie, false);
    $aLocais= ConsultarDados("locais", "cdclie", $cdclie, false);
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-hotel"></i> Cadastro de Reservas/Hospedagens - <small>Inclusão</small>
                        </button>
                    </div>
                    <div class="ibox-content">
                            ...
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="reservasg.php">
                                    ...
                                    <div id="tab-1" class="tab-pane active">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="cdhosp" id="cdhosp" maxlength="50">
                                                        <?php for($i=0;$i < count($aHospedes);$i++) { ?>
                                                            <option><?php echo str_pad($aHospedes[$i]["cdhosp"],15," ",STR_PAD_LEFT)." - ".$aHospedes[$i]["dehosp"] ;?></option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="cdloca" id="cdloca" maxlength="50">
                                                        <?php for($i=0;$i < count($aLocais);$i++) { ?>
                                                            <option><?php echo str_pad($aLocais[$i]["cdloca"],15," ",STR_PAD_LEFT)." - ".$aLocais[$i]["deloca"] ;?></option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-1">
                                                    <input id="qthosp" name="qthosp" value="" type="number" placeholder="1" class="form-control" maxlength = "2">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input id="dtentp" name="dtentp" value="" type="date" placeholder="" class="form-control" maxlength = "2">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input id="dtsaip" name="dtsaip" value="" type="date" placeholder="" class="form-control" maxlength = "2">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <input id="vlante" name="vlante" value="" type="text" placeholder="0,00" class="form-control" maxlength = "10">
                                                </div>
                                            </div>
                                    ...
                                    <div id="tab-2" class="tab-pane">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <textarea class="form-control" id="dehosp" wrap="physical" cols=50 rows=10 name="dehosp" placeholder="Ex: Nomes, RG, CPF, Grau de Parentesco"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="tab-3" class="tab-pane">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <textarea class="form-control" id="deobse" wrap="physical" cols=50 rows=10 name="deobse" placeholder="Ex: Quer uma cama solteiro extra para filho."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
