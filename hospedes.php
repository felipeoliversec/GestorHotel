<?php
    ...
    $aHospedes= ConsultarDados("hospedes", "cdclie", $cdclie, false, false);
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-user-plus"></i> Cadastro de Hóspedes
                        </button>
                    </div>
                    <div class="ibox-content">
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="usuariosa.php"-->
                            <div class="pull-left">
                                <a onclick="#" href="hospedesi.php" class="btn btn-primary ">Incluir</a>
                            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    <thead>
                                        <tr>
                                            ...
                                            <th>E-Mail</th>
                                            <th>Ultima Estadia</th>
                                            <th>Ativo</th>
                                            <th class="text-right" data-sort-ignore="true">Ação</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php for ($f =0; $f <= (count($aHospedes)-1); $f++) { ?>
                                            <tr class="gradeX">

                                                <?php $data = strtotime($aHospedes[$f]["dtulti"]);?>

                                                <?php $coluna1 = $aHospedes[$f]["cdhosp"]; ?>
                                                <?php $coluna2 = $aHospedes[$f]["dehosp"]; ?>
                                                <?php $coluna3 = $aHospedes[$f]["demail"]; ?>
                                                <?php if ($data < 0) {?>
                                                    <?php $coluna4 = ""; ?>
                                                <?php } Else {?>
                                                    <?php $coluna4 = date("d/m/Y",$data); ?>
                                                <?php }?>

                                                <?php $coluna5 = $aHospedes[$f]["flativ"]; ?>

                                                <?php $ver = "hospedesa.php?acao=ver&chave=".$coluna1; ?>
                                                <?php $edita = "hospedesa.php?acao=edita&chave=".$coluna1; ?>
                                                <?php $apaga = "hospedesa.php?acao=apaga&chave=".$coluna1; ?>
