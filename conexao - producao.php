<?php
    ...
    if (mysqli_connect_errno($conexao)) {
        echo "Problemas para conectar no banco de dados Weber Hotel. Se o problema persistir, pedimos desculpas e, por favor, envie um e-mail para nós - suporte@sofcom.com.br";
        die();
    }
