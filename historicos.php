<?php
    ...
    $aDados= ConsultarDados("clientes", "cdclie", $cdclie, false, false);
    $declie= trim($aDados[0]["declie"]);

    $aHistoricos= ConsultarDados("iplog", "cdclie", $cdclie, false, false);
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-user"></i> Histórico de Ações
                        </button>
                    </div>
                    <div class="ibox-content">
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="usuariosa.php"-->
                            <!--div class="pull-left"-->
                                <!--a onclick="#" href="usuariosi.php" class="btn btn-primary ">Incluir</a-->
                            <!--/div-->
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        <?php for ($f =0; $f <= (count($aHistoricos)-1); $f++) { ?>
                                            <tr class="gradeX">

                                                <?php $codusua = $aHistoricos[$f]["cdusua"];?>
                                                <?php $aUsu= ConsultarDados("usuarios", "cdusua", $codusua, false, false); ?>

                                                <?php if (count($aUsu) > 0) {?>
                                                    <?php $decodi= $aUsu[0]["deusua"]; ?>
                                                <?php } Else {?>
                                                    <?php $decodi= "Desconhecido"; ?>
                                                <?php } ?>

                                                <?php $data = strtotime($aHistoricos[$f]["dtiplo"]);?>

                                                <?php $coluna1 = $codusua; ?>
                                                <?php $coluna2 = $decodi; ?>
                                                <?php $coluna3 = date("d/m/Y H:i:s",$data); ?>
                                                <?php $coluna4 = $aHistoricos[$f]["cdprod"]; ?>
                                                <?php $coluna5 = $aHistoricos[$f]["deacao"]; ?>
                                                <?php $coluna6 = $aHistoricos[$f]["ip"]; ?>
