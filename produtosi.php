                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-shopping-cart"></i> Cadastro de Produtos - <small>Inclusão</small>
                        </button>
                    </div>
                    <div class="ibox-content">
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="meusdadosg.php"-->

                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="produtosg.php">
                                ...
                                <div class="row">
                                    <!--div class="col-lg-6"-->
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2 ">
                                                <input id="cdprod" name="cdprod" type="text" value="" placeholder="Prod-B" class="form-control" maxlength = "15" autofocus required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Descrição</label>
                                            <div class="col-md-8">
                                                <input id="deprod" name="deprod" value="" type="text" placeholder="Balas de Goma" class="form-control" maxlength = "50" required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Preço</label>
                                            <div class="col-md-2">
                                                <input id="vlprod" name="vlprod" value="1,00" type="text" placeholder="" class="form-control" maxlength = "10">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Quantidade</label>
                                            <div class="col-md-2">
                                                <input id="qtprod" name="qtprod" value="0" type="text" placeholder="" class="form-control" maxlength = "5">
                                            </div>
                                        </div>
                                        <div class="form-group">
