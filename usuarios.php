<?php
    ...
    $aUsuarios= ConsultarDados("usuarios", "cdclie", $cdclie, false, false);
                        ...
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="usuariosa.php"-->
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        <?php for ($f =0; $f <= (count($aUsuarios)-1); $f++) { ?>
                                            <tr class="gradeX">

                                                <?php $coluna1 = $aUsuarios[$f]["cdusua"]; ?>
                                                <?php $coluna2 = $aUsuarios[$f]["deusua"]; ?>
                                                <?php $coluna3 = $aUsuarios[$f]["demail"]; ?>
                                                <?php $coluna4 = $aUsuarios[$f]["fladmi"]; ?>
                                                <?php $coluna5 = $aUsuarios[$f]["flativ"]; ?>
