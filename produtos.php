                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-shopping-cart"></i> Cadastro de Produtos
                        </button>
                    </div>
                    <div class="ibox-content">
                        <!--form class="form-horizontal" method="POST" enctype="multipart/form-data" action="usuariosa.php"-->
                            <div class="pull-left">
                                <a onclick="#" href="produtosi.php" class="btn btn-primary ">Incluir</a>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        <?php for ($f =0; $f <= (count($aProdutos)-1); $f++) { ?>
                                            <tr class="gradeX">

                                                <?php $data = strtotime($aProdutos[$f]["dtcada"]) ;?>
                                                <?php $preco = number_format($aProdutos[$f]["vlprod"],2,',','.') ;?>

                                                <?php $coluna1 = $aProdutos[$f]["cdprod"]; ?>
                                                <?php $coluna2 = $aProdutos[$f]["deprod"]; ?>
                                                <?php $coluna3 = $preco; ?>
                                                <?php $coluna4 = $aProdutos[$f]["qtprod"]; ?>
                                                <?php $coluna5 = date("d/m/Y",$data); ?>

                                                <?php $ver = "produtosa.php?acao=ver&chave=".$coluna1; ?>
                                                <?php $edita = "produtosa.php?acao=edita&chave=".$coluna1; ?>
                                                <?php $apaga = "produtosa.php?acao=apaga&chave=".$coluna1; ?>
