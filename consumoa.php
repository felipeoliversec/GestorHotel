<?php
    ...
    $aConsumo= ConsultarDados("consumo", "nrsequ", $chave, false, false, $cdclie);
    $flcons = $aConsumo[0]["flcons"];
    $qtcons = $aConsumo[0]["qtcons"];
    $vlcons = $aConsumo[0]["vlcons"];
    $vlprec = $aConsumo[0]["vlprec"];
    $dtcons = $aConsumo[0]["dtcons"];
    $cdrese = $aConsumo[0]["cdrese"];

    if ($flcons == "P"){
        $cdcons=$aConsumo[0]["cdcons"];
        $aProdutos= ConsultarDados("produtos", "cdprod", $cdcons, false, false, $cdclie);
        $decons=trim($aProdutos[0]["deprod"]);
    }
    if ($flcons == "S"){
        $cdcons=$aConsumo[0]["cdcons"];
        $aServicos= ConsultarDados("servicos", "cdserv", $cdcons, false, false, $cdclie);
        $decons=trim($aServicos[0]["deserv"]);
    }
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-hotel"></i> Consumo - <small><?php echo $titulo; ?></small>
                        </button>
                    </div>
                    <div class="ibox-content">

                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="consumoaa.php">
                                ...
                                <!--div id="tab-1" class="tab-pane active"-->
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="nrsequ" id="nrsequ" value="<?php echo $chave ;?>">
                                        <input type="hidden" name="cdrese" id="cdrese" value="<?php echo $cdrese ;?>">
                                        <input type="hidden" name="cdcons" id="cdcons" value="<?php echo $cdcons ;?>">

                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Produto/Serviço</label>  
                                            <div class="col-md-4">
                                                <input id="decons" name="decons" value="<?php echo $cdcons." - ".$decons ;?>" type="text" placeholder="" class="form-control" readonly="" maxlength = "80">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <!--?php $dtcons = $dtcons;?-->
                                            <?php $dtcons = date("d/m/Y H:i:s",strtotime($dtcons))?>
                                            <label class="col-md-2 control-label" for="textinput">Data</label>
                                            <div class="col-md-3">
                                                <input id="dtcons" name="dtcons" value="<?php echo $dtcons ;?>" type="text" placeholder="" class="form-control" maxlength = "15" readonly="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-1">
                                                <input id="qtcons" name="qtcons" value="<?php echo $qtcons ;?>" type="number" placeholder="" class="form-control" maxlength = "2" autofocus="">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Valor Unitário R$</label>
                                            <?php $vlprec = number_format($vlprec,2,',','.') ; ?>
                                            <div class="col-md-2">
                                                <input id="vlprec" name="vlprec" value="<?php echo $vlprec;?>" type="text" placeholder="0,00" class="form-control" maxlength = "18">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-2 control-label" for="textinput">Valor Total R$</label>
                                            <?php $vlcons = number_format($vlcons,2,',','.') ; ?>
                                            <div class="col-md-2">
