                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block"><i
                                                    class="fa fa-user"></i> Cadastro de Usuários - <small>Inclusão</small>
                        </button>
                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <input id="cdusua" name="cdusua" type="text" value="" placeholder="somente números" class="form-control" maxlength = "11" autofocus required="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input id="desenh" name="desenh" value="" type="desenh" placeholder="" class="form-control" maxlength = "255">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-md-3 control-label" for="textinput">Administrador?</label>
                                                    <div class="col-md-6">
                                                        <select name="fladmi" id="fladmi">
