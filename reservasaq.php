            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                            ...
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="reservasaaq.php">
                                ...
                                <div class="tab-content">
                                    <div id="tab-1" class="tab-pane active">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label" for="textinput">Quarto/Suíte/Chalé</label>  
                                                <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-1">
                                                    <input id="qthosp" name="qthosp" value="<?php echo $aReservas[0]["qthosp"];?>" type="number" placeholder="" class="form-control" maxlength = "2" readonly="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input id="dtconf" name="dtconf" value="<?php echo $aReservas[0]["dtconf"];?>" type="date" placeholder="" class="form-control" readonly="" maxlength = "15">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input id="dtentp" name="dtentp" value="<?php echo $aReservas[0]["dtentp"];?>" type="date" placeholder="" class="form-control" maxlength = "10" readonly="">
                                                </div>
                                                <label class="col-md-2 control-label" for="textinput">Saída Prevista</label>
                                                <div class="col-md-3">
                                                    <input id="dtsaip" name="dtsaip" value="<?php echo $aReservas[0]["dtsaip"];?>" type="date" placeholder="" class="form-control" maxlength = "10" readonly="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input id="dtentr" name="dtentr" value="<?php echo $aReservas[0]["dtentr"];?>" type="date" placeholder="" class="form-control" maxlength = "15" readonly="">
                                                </div>
                                                <label class="col-md-2 control-label" for="textinput">Saída Efetiva</label>
                                                <div class="col-md-3">
                                                    <input id="dtsaid" name="dtsaid" value="<?php echo $aReservas[0]["dtsaid"];?>" type="date" placeholder="" class="form-control" maxlength = "15" readonly="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <input id="vlrese" name="vlrese" value="<?php echo $vlrese;?>" type="text" placeholder="0,00" class="form-control" maxlength = "18" readonly="">
                                                </div>
                                                <label class="col-md-2 control-label" for="textinput">Valor do Consumo R$</label>
                                                <?php $vlcons = number_format($aReservas[0]["vlcons"],2,',','.') ; ?>
                                                <div class="col-md-3">
                                                    <input id="vlcons" name="vlcons" value="<?php echo $vlcons;?>" type="text" placeholder="0,00" class="form-control" maxlength = "18" readonly="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <input id="vlante" name="vlante" value="<?php echo $vlante;?>" type="text" placeholder="0,00" class="form-control" maxlength = "18" readonly = "">
                                                </div>
                                                <?php if (is_null($aReservas[0]["vlpago"]) == true or $aReservas[0]["vlpago"] < 1.00) {?>
                                                    <label class="col-md-3 control-label" for="textinput">Valor Total R$</label>
                                                    <?php $vlpago =  $aReservas[0]["vlante"] + ($aReservas[0]["vlcons"] + $aReservas[0]["vlrese"]); ?>
                                                ...
                                                <?php }?>
                                                <div class="col-md-3">
                                                    <input id="vlpago" name="vlpago" value="<?php echo $vlpago;?>" type="text" placeholder="0,00" class="form-control" maxlength = "18">
                                                    <span><small><strong>O valor antecipado está somado aqui</strong></small></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="tab-2" class="tab-pane">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <textarea class="form-control" id="dehosp" wrap="physical" cols=50 rows=10 name="dehosp" placeholder="" readonly=""><?php echo $aReservas[0]["dehosp"];?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="tab-3" class="tab-pane">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <textarea class="form-control" id="deobse" wrap="physical" cols=50 rows=10 name="deobse" placeholder="" readonly><?php echo $aReservas[0]["deobse"];?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <center>
                                        ...
                                        <?php }?>
                                        <?php if($acao == "pagar") {?>
                                            <button class="btn btn-sm btn-info" name = "pagar" type="submit"><strong>Fechar/Pagar</strong></button>
                                        <?php }?>
                                    </center>
                                </div>
